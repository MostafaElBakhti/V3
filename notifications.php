<?php
// notifications.php - API endpoint for fetching notifications
        ...
        case 'fetch':
            ...
            $stmt = $pdo->prepare("
                SELECT n.*, 
                       ...
                       CASE 
                           WHEN n.created_at >= NOW() - INTERVAL 1 MINUTE THEN 'now'
            ...
            // Get unread count
            $count_stmt = $pdo->prepare("SELECT COUNT(*) as unread_count FROM notifications WHERE user_id = ? AND is_read = FALSE");
...
<!-- Notification Component HTML/CSS/JS -->
<style>
